...
export default function Catalog() {
    return (
        ...
        <section className="px-8 pt-4 pb-16">
            ...
            <hr className="my-4" />
            <div className="my-4 flex justify-between w-10/12 mx-auto">
            ...
            <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-4 justify-items-center align-items-center w-10/12 mx-auto mt-8">
                <CardProduct />
                <CardProduct />
                <CardProduct />
                <CardProduct />
